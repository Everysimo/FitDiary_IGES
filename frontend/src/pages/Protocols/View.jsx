                                    ...
                                    <Accordion>
                                        <AccordionItem>
                                            <AccordionButton onClick={() => navigate("/dietcards/" + protocollo.id)}>
                                                <Image boxSize='30px' htmlHeight='10px' objectFit='cover' src={meal}
                                                       mr={3}/>
                            ...
                            {protocollo.schedaAllenamento ? (
                                <GridItem colSpan={colSpan}>
                                    ...
                                    {_(protocollo.schedaAllenamento.frequenza).times(i => {
                                        return (
                                            <AccordionTraining key={i} schedaAllenamento={protocollo.schedaAllenamento}
                                                               nome={"Allenamento " + (i + 1)}
                                                               numeroAllenamento={(i + 1).toString()}/>)
                                    })}
                                    <Accordion>
                                        <AccordionItem>
                                            <AccordionButton
                                                onClick={() => navigate("/trainingcards/" + protocollo.id)}>
                                                <Image boxSize='30px' htmlHeight='10px' objectFit='cover' src={training}
                                                       mr={3}/>

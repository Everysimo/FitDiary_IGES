...
INSERT INTO `istanza_esercizio` (`id`, `giorno_della_settimana`, `serie`, `ripetizioni`, `recupero`,`descrizione`,
                                 `esercizio_id`,`scheda_allenamento_id`) VALUES (1,4, 2, 1, 1,'istanza ese',1,3);
